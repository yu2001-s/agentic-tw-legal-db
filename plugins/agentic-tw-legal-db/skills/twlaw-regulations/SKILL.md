...
description: Use when the user asks to query, verify, cite, or research Taiwan Ministry of Justice laws, regulations, articles, pcodes, law histories, Chinese or English law/order text, or recent MOJ law/order/draft updates through the `twlaw` CLI. This skill is CLI-only and must not use MCP.
---
